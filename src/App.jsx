...
function SetupPanel({ event, onSave, onClose }) {
  ...
  const fields = [
    ...
    { key: "date", label: "Date", placeholder: "May 15, 2026", type: "text" },
...
export default function SonaAgent() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hey — I'm Sona, your AI event planner.\n\nSet up your event details using the ✦ button in the sidebar, and I'll tailor every response to your specific event.\n\nLet's build something worth attending.",
      workstream: null,
    },
  ]);
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .setup-btn {
          ...
          padding: 10px 14px; cursor: pointer; transition: all 0.2s ease;
        ...
        <div style={{
          ...
          <div style={{ marginBottom: "20px", paddingLeft: "4px" }}>
            ...
            <div style={{
              ...
              color: "#3A3A5A", letterSpacing: "0.15em", marginTop: "3px",
          ...
          {/* Clear chat */}
          <button
            onClick={() => { setMessages([{ role: "assistant", content: "Chat cleared. What do you need?", workstream: null }]); setHistory([]); }}
            style={{
